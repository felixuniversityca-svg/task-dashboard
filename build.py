  ...
  <style>
    *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0}}
    ...
    .graph-wrap{{background:#0d0d10;border:1px solid rgba(255,255,255,0.08);
                ...
                position:relative}}
    .graph-stats{{font-size:10px;color:rgba(255,255,255,0.35);
                  padding:8px 12px 0;pointer-events:none}}
    #graph-canvas{{width:100%;height:260px;display:block}}
    }}
  </style>
</head>
<body>
...
(function() {{
  ...
  const Graph = ForceGraph3D({{ controlType: 'orbit', rendererConfig: {{ antialias: true, alpha: true }} }})(el)
    ...
    .nodeLabel(n => '<span style="font-size:12px;background:rgba(0,0,0,0.7);padding:2px 6px;border-radius:4px">' + n.name + '</span>')
    .nodeResolution(10)
    .nodeRelSize(3)
